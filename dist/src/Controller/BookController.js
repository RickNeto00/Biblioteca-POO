...
const Book_1 = __importStar(require("../Model/Book"));
...
class BookController {
    ...
    select() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.book.selectAll(new Book_1.default(1, "Livro Test", 2002, new PubCompany_1.default(1, "Companyteste", "2000"), new Author_1.default(1, "Joao", 20, "clpj0r9j50000n2u95cpvrru1"), Book_1.BookTypes.Horror));
        });
    }
}
